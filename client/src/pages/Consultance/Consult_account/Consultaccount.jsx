...
function Consultaccount() {
  return (
    <div className='Consult-port-container pt-16'>
    <Navbar />
      <div className='form shadow-lg shadow-gray-500 mx-auto relative bounce'>
            <div className='batch theme2 w-52 h-10 text-white text-center flex text-xl justify-center items-center shadow-md shadow-gray-700'>บัญชี Consultance<consultance></consultance></div>
